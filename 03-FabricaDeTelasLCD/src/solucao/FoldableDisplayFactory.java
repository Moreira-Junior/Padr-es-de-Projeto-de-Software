...
public class FoldableDisplayFactory implements DisplayFactory{
    @Override
    public TabletDisplay createTabletDisplay(double inches, String features) {
        TabletDisplay display = new FoldableTabletDisplay(inches, features);
        display.assemble();
    ...
    public SmartphoneDisplay createSmartphoneDisplay(double inches, String features) {
        SmartphoneDisplay display = new FoldableSmartphoneDisplay(inches, features);
        display.assemble();
        this.qualityTest(display);
        return display;
    }
